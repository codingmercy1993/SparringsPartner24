...
urlpatterns = [
    ...
    path('create_fighter_profile/', views.create_fighter_profile, name = 'create_fighter_profile'),
    path('edit_fighter_profile/', views.edit_fighter_profile, name = 'edit_fighter_profile'),
    path('create_search_profile/', views.create_search_profile, name = 'create_search_profile'),
